...
-- -- ============================================
-- -- 添加 负责人 字段到 user_song_relations
-- -- ============================================

-- ALTER TABLE user_song_relations
--   ADD COLUMN IF NOT EXISTS supervisor TEXT;  -- 负责人（单值）

-- COMMENT ON COLUMN user_song_relations.supervisor IS '用户指定的负责人';

-- -- 验证
-- SELECT column_name, data_type 
-- FROM information_schema.columns 
-- WHERE table_name = 'user_song_relations' 
